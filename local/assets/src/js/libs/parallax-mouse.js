...
data-prlx-a=«скорость_анимации» 50 значение больше - больше скорость

// =========
Если нужно считывать движение мыши в блоке-отце - тому отцу указать атрибут data-prlx-mouse-wrapper
  ...
  constructor(props, data = null) {
    ...
    if (this.config.init) {
      ...
      if (paralaxMouse.length) {
        ...
        this.setLogging('Нет объектов. Сплю...');
      }
    }
  }
